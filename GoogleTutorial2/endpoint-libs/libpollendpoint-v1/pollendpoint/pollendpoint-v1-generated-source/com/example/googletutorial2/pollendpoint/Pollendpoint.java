...
package com.example.googletutorial2.pollendpoint;
...
public class Pollendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.16.0-rc of the pollendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @return the request
   */
  public GetPoll getPoll(java.lang.Long id) throws java.io.IOException {
    GetPoll result = new GetPoll(id);
    initialize(result);
    return result;
  }

  public class GetPoll extends PollendpointRequest<com.example.googletutorial2.pollendpoint.model.Poll> {
     ...
     * @since 1.13
     */
    protected GetPoll(java.lang.Long id) {
      super(Pollendpoint.this, "GET", REST_PATH, null, com.example.googletutorial2.pollendpoint.model.Poll.class);
    ...
    public GetPoll setId(java.lang.Long id) {
      this.id = id;
      return this;
    }
   ...
   *
   * This request holds the parameters needed by the the pollendpoint server.  After setting any
   * optional parameters, call the {@link InsertPoll#execute()} method to invoke the remote operation.
   *
   * @param content the {@link com.example.googletutorial2.pollendpoint.model.Poll}
   * @return the request
   */
  public InsertPoll insertPoll(com.example.googletutorial2.pollendpoint.model.Poll content) throws java.io.IOException {
    InsertPoll result = new InsertPoll(content);
    initialize(result);
    return result;
  }

  public class InsertPoll extends PollendpointRequest<com.example.googletutorial2.pollendpoint.model.Poll> {
     ...
     * @since 1.13
     */
    protected InsertPoll(com.example.googletutorial2.pollendpoint.model.Poll content) {
      super(Pollendpoint.this, "POST", REST_PATH, content, com.example.googletutorial2.pollendpoint.model.Poll.class);
    }
  ...
  public class ListPoll extends PollendpointRequest<com.example.googletutorial2.pollendpoint.model.CollectionResponsePoll> {
     ...
     */
    protected ListPoll() {
      super(Pollendpoint.this, "GET", REST_PATH, null, com.example.googletutorial2.pollendpoint.model.CollectionResponsePoll.class);
    }
   ...
   *
   * This request holds the parameters needed by the the pollendpoint server.  After setting any
   * optional parameters, call the {@link RemovePoll#execute()} method to invoke the remote operation.
   *
   * @param id
   * @return the request
   */
  public RemovePoll removePoll(java.lang.Long id) throws java.io.IOException {
  ...
  public class RemovePoll extends PollendpointRequest<Void> {
     ...
     * @since 1.13
     */
    protected RemovePoll(java.lang.Long id) {
    ...
    public RemovePoll setId(java.lang.Long id) {
      this.id = id;
      return this;
    }
   ...
   *
   * This request holds the parameters needed by the the pollendpoint server.  After setting any
   * optional parameters, call the {@link UpdatePoll#execute()} method to invoke the remote operation.
   *
   * @param content the {@link com.example.googletutorial2.pollendpoint.model.Poll}
   * @return the request
   */
  public UpdatePoll updatePoll(com.example.googletutorial2.pollendpoint.model.Poll content) throws java.io.IOException {
    UpdatePoll result = new UpdatePoll(content);
    initialize(result);
    return result;
  }

  public class UpdatePoll extends PollendpointRequest<com.example.googletutorial2.pollendpoint.model.Poll> {
     ...
     * @since 1.13
     */
    protected UpdatePoll(com.example.googletutorial2.pollendpoint.model.Poll content) {
      super(Pollendpoint.this, "PUT", REST_PATH, content, com.example.googletutorial2.pollendpoint.model.Poll.class);
    }
