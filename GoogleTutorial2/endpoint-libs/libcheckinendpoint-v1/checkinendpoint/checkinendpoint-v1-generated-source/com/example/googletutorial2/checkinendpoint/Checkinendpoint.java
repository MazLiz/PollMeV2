 ...
 * on 2014-01-10 at 11:46:57 UTC 
 * Modify at your own risk.
 */

package com.example.googletutorial2.checkinendpoint;
...
public class Checkinendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetCheckIn extends CheckinendpointRequest<com.example.googletutorial2.checkinendpoint.model.CheckIn> {
    ...
    protected GetCheckIn(java.lang.Long id) {
      super(Checkinendpoint.this, "GET", REST_PATH, null, com.example.googletutorial2.checkinendpoint.model.CheckIn.class);
   ...
   * operation.
   *
   * @param content the {@link com.example.googletutorial2.checkinendpoint.model.CheckIn}
   * @return the request
   */
  public InsertCheckIn insertCheckIn(com.example.googletutorial2.checkinendpoint.model.CheckIn content) throws java.io.IOException {
    InsertCheckIn result = new InsertCheckIn(content);
    initialize(result);
    return result;
  }

  public class InsertCheckIn extends CheckinendpointRequest<com.example.googletutorial2.checkinendpoint.model.CheckIn> {
     ...
     * @since 1.13
     */
    protected InsertCheckIn(com.example.googletutorial2.checkinendpoint.model.CheckIn content) {
      super(Checkinendpoint.this, "POST", REST_PATH, content, com.example.googletutorial2.checkinendpoint.model.CheckIn.class);
    }
  ...
  public class ListCheckIn extends CheckinendpointRequest<com.example.googletutorial2.checkinendpoint.model.CollectionResponseCheckIn> {
    ...
    protected ListCheckIn() {
      super(Checkinendpoint.this, "GET", REST_PATH, null, com.example.googletutorial2.checkinendpoint.model.CollectionResponseCheckIn.class);
    }
   ...
   * @return the request
   */
  public UpdateCheckIn updateCheckIn(com.example.googletutorial2.checkinendpoint.model.CheckIn content) throws java.io.IOException {
    UpdateCheckIn result = new UpdateCheckIn(content);
    initialize(result);
    return result;
  }

  public class UpdateCheckIn extends CheckinendpointRequest<com.example.googletutorial2.checkinendpoint.model.CheckIn> {
     ...
     * @since 1.13
     */
    protected UpdateCheckIn(com.example.googletutorial2.checkinendpoint.model.CheckIn content) {
      super(Checkinendpoint.this, "PUT", REST_PATH, content, com.example.googletutorial2.checkinendpoint.model.CheckIn.class);
    }
